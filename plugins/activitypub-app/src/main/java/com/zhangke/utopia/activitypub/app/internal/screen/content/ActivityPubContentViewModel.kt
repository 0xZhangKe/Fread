...
class ActivityPubContentViewModel(
    ...
    private val _uiState = MutableStateFlow<LoadableState<ActivityPubContentUiState>>(LoadableState.idle())
    ...
    fun onPrepared() {
        ...
        launchInViewModel {
            ...
            val contentConfig = contentConfigRepo.getConfigById(configId) as? ContentConfig.ActivityPubContent
