...
class BlockedUserListScreen(
    ...
    override fun Content() {
        ...
        val viewModel = getViewModel<BlockedUserListViewModel, BlockedUserListViewModel.Factory> {
            it.create(role)
        }
        val uiState by viewModel.uiState.collectAsState()
        val snackBarHostState = rememberSnackbarHostState()
        BlockedUserListContent(
            uiState = uiState,
    ...
    @Composable
    private fun BlockedUserListContent(
        ...
        Scaffold(
            topBar = {
                Toolbar(
                    title = stringResource(R.string.activity_pub_blocked_user_list_title),
            ...
            Box(
                ...
                CommonUserPage(
                    ...
                    emptyText = stringResource(R.string.activity_pub_blocked_user_list_empty)
                )
            }
        }
    }
