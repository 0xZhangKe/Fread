...
interface ActivityPubComponent {

    val author: ActivityPubOAuthor

    @Provides
    fun provideActivityPubDatabases(context: ApplicationContext): ActivityPubDatabases {
        return ActivityPubDatabases.getInstance(context)
    }

    @Provides
    fun provideNotificationsDatabase(context: ApplicationContext): NotificationsDatabase {
        return NotificationsDatabase.getInstance(context)
    }

    @Provides
    fun provideActivityPubStatusDatabase(context: ApplicationContext): ActivityPubStatusDatabases {
