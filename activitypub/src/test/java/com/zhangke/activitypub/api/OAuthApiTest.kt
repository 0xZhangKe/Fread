...
import com.zhangke.activitypub.utils.MASTODON
...
class OAuthApiTest {
    ...
    private val activityPub = ActivityPubClient(mastodonUtopiaApplication, retrofit, Gson())
        ...
        runBlocking {
            try {
                activityPub.oauthRepo.registerApplication(
                    ...
                    scopes = OAuthRepo.AppScopes.ALL,
