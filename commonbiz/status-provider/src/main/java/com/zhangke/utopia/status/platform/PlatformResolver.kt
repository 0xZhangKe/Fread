...
class PlatformResolver constructor(
    ...
    suspend fun resolveBySourceUri(uri: String): Result<UtopiaPlatform?> {
    ...
    suspend fun resolveBySourceUriList(uriList: List<String>): Result<List<UtopiaPlatform>> {
...
interface IPlatformResolver {
    ...
    suspend fun resolveBySourceUri(sourceUri: StatusProviderUri): Result<UtopiaPlatform?>
}
