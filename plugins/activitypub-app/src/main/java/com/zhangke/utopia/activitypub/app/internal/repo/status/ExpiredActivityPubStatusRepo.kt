...
import com.zhangke.utopia.activitypub.app.internal.db.status.ExpiredActivityPubStatusDao
import com.zhangke.utopia.activitypub.app.internal.db.status.ExpiredActivityPubStatusDatabase
import com.zhangke.utopia.activitypub.app.internal.db.status.ExpiredActivityPubStatusTableEntity
...
class ExpiredActivityPubStatusRepo @Inject constructor(
    private val statusDatabase: ExpiredActivityPubStatusDatabase,
) {

    private val statusDao: ExpiredActivityPubStatusDao get() = statusDatabase.getDao()
