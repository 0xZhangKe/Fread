...
import com.zhangke.fread.commonbiz.shared.screen.post_status_image_generate_alt_downloadable_content
import com.zhangke.fread.commonbiz.shared.screen.post_status_image_generate_alt_downloading
...
class GenerateImageAltScreen(private val imageUri: String) : BaseScreen() {
    ...
    private fun GenerateImageAltScreenContent(
        ...
        Scaffold(
            topBar = {
                Toolbar(
                    title = stringResource(Res.string.post_status_image_generate_alt),
            ...
            Column(
                ...
                Text(
                    modifier = Modifier.fillMaxWidth()
                        .padding(16.dp),
                    text = stringResource(Res.string.post_status_image_generate_alt_hint),
                ...
                Button(
                    ...
                    Text(
                        text = stringResource(Res.string.post_status_image_generate_alt_generate)
                    )
                }
                ...
                if (uiState.downloadState is ImageAiModelDownloadState.Success) {
                    FreadDialog(
                        ...
                        contentText = stringResource(Res.string.post_status_image_generate_alt_downloading_success),
                ...
                if (uiState.downloadState is ImageAiModelDownloadState.Failure) {
                    FreadDialog(
                        ...
                        contentText = stringResource(Res.string.post_status_image_generate_alt_downloading_failure),
                ...
                if (uiState.downloadState is ImageAiModelDownloadState.Started ||
                    ...
                    FreadDialog(
                        ...
                        title = stringResource(Res.string.post_status_image_generate_alt_downloading),
                        content = {
                            CircularProgressIndicator(
