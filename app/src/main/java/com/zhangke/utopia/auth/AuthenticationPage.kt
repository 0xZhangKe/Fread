package com.zhangke.utopia.auth
        ...
        Card(
            ...
            Column {
                ...
                val loginMessageResId =
                    if (isOauthFailed) R.string.authentication_page_failed_title else R.string.authentication_page_normal_title
                ...
                Row(
                    ...
                    Button(
                        ...
                        Text(text = stringResource(com.zhangke.utopia.commonbiz.R.string.login))
                    }
                }
            }
        }
