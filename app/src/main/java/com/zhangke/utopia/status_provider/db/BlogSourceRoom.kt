package com.zhangke.utopia.status_provider.db
...
import com.zhangke.utopia.status_provider.BlogFeeds
...
object BlogSourceRepo {
    ...
    suspend fun insertFeeds(name: String, sourceList: List<StatusSource>) {
    ...
    private fun StatusSource.toEntry(): BlogSourceEntry {
    ...
    private fun BlogSourceEntry.toSource(): StatusSource {
        return StatusSource(
            sourceName = sourceName,
            uri = sourceServer,
            sourceDescription = sourceDescription,
    ...
    private fun generateBlogSourceKey(source: StatusSource): String {
