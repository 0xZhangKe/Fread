...
private const val DB_NAME = "activity_pub_status_read_state.db"
...
abstract class ActivityPubStatusReadStateDatabases : RoomDatabase() {
    ...
    companion object {
        ...
        private var instance: ActivityPubStatusReadStateDatabases? = null

        fun getInstance(context: Context): ActivityPubStatusReadStateDatabases {
            if (instance == null) {
                synchronized(ActivityPubStatusReadStateDatabases::class.java) {
                    if (instance == null) {
        ...
        private fun createDatabase(context: Context): ActivityPubStatusReadStateDatabases {
